    ...
    <React.Fragment>
      <section className="bg-gradient-to-l pt-10 from-yellow-200 to-green-100">
        <main className="pb-16">
          ...
          <p className="text-[15px] md:text-[18px] lg:text-[22px] xl:text-[24px] font-normal text-center mt-8">Jl. Raya Sukoraharjo No.326, Blobo, Sukoharjo, Kec. Kepanjen, Kabupaten Malang, Jawa Timur 65163</p>
        </main>
