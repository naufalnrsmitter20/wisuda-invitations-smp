  ...
  return (
    <header className="relative h-screen w-full">
      ...
      <main className="mx-auto max-w-5xl mt-16">
        ...
        <h1 className="font-Poppins text-[32px] md:text-[42px] lg:text-[52px] xl:text-[64px] uppercase text-center mt-[10px]">PURNAWIYATA SISWA KELAS IX</h1>
        <h1 className="font-Poppins text-[32px] md:text-[42px] lg:text-[52px] xl:text-[64px] uppercase text-center mt-[6px]">Tahun Ajaran 2023/2024</h1>
