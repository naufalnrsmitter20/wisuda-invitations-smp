...
export default function Header() {
  ...
  return (
    <header className="relative h-screen w-full">
      <Image src={mainBG} alt="mainbg" className="absolute -z-10 w-full h-screen" />
      ...
      <main className="mx-auto max-w-5xl mt-44">
        <h2 className="font-Judson text-[36px] uppercase text-center">Undangan</h2>
        <h1 className="font-Jacques_Francois text-[64px] uppercase text-center mt-[6px]">WISUDA ANGKATAN XXI</h1>
        <h2 className="font-Judson text-[36px] uppercase text-center mt-[28px]">SMP NEGERI 3 KEPANJEN</h2>
        <h2 className="font-Judson text-[36px] uppercase text-center mt-[10px] font-semibold">15 . 06 . 2024</h2>
      </main>
      <footer>
        <Image src={grad1left} alt="gambar" className="absolute bottom-0 -z-10 left-0" />
        <Image src={grad1right} alt="gambar" className="absolute bottom-0 -z-10 right-0" />
